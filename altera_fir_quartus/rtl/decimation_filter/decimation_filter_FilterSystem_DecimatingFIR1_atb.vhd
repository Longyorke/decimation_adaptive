...
-- VHDL created on Sun Feb 23 15:26:34 2025
...
entity decimation_filter_FilterSystem_DecimatingFIR1_atb is
end;

architecture normal of decimation_filter_FilterSystem_DecimatingFIR1_atb is

component decimation_filter_FilterSystem_DecimatingFIR1 is
    port (
        xIn_v : in std_logic_vector(0 downto 0);  -- sfix1
        xIn_c : in std_logic_vector(7 downto 0);  -- sfix8
        xIn_0 : in std_logic_vector(16 downto 0);  -- sfix17
        busIn_writedata : in std_logic_vector(15 downto 0);  -- sfix16
        busIn_address : in std_logic_vector(10 downto 0);  -- sfix11
...
component decimation_filter_FilterSystem_DecimatingFIR1_stm is
    port (
...
signal xIn_0_stm : STD_LOGIC_VECTOR (16 downto 0);
...
signal xOut_0_stm : STD_LOGIC_VECTOR (36 downto 0);
signal xIn_v_dut : STD_LOGIC_VECTOR (0 downto 0);
signal xIn_c_dut : STD_LOGIC_VECTOR (7 downto 0);
signal xIn_0_dut : STD_LOGIC_VECTOR (16 downto 0);
...
signal xOut_0_dut : STD_LOGIC_VECTOR (36 downto 0);
...
dut : decimation_filter_FilterSystem_DecimatingFIR1 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
...
sim : decimation_filter_FilterSystem_DecimatingFIR1_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    busIn_writedata_stm,
