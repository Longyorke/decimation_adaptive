...
-- VHDL created from decimation_filter_FilterSystem_Scale3
-- VHDL created on Sun Feb 23 15:26:35 2025
...
entity decimation_filter_FilterSystem_Scale3_atb is
end;

architecture normal of decimation_filter_FilterSystem_Scale3_atb is

component decimation_filter_FilterSystem_Scale3 is
    port (
        xIn_v : in std_logic_vector(0 downto 0);  -- sfix1
        xIn_c : in std_logic_vector(7 downto 0);  -- sfix8
        xIn_0 : in std_logic_vector(37 downto 0);  -- sfix38
        ...
        qOut_0 : out std_logic_vector(16 downto 0);  -- sfix17
...
component decimation_filter_FilterSystem_Scale3_stm is
    port (
        xIn_v_stm : out std_logic_vector(0 downto 0);
        xIn_c_stm : out std_logic_vector(7 downto 0);
        xIn_0_stm : out std_logic_vector(37 downto 0);
        ...
        qOut_0_stm : out std_logic_vector(16 downto 0);
...
signal xIn_0_stm : STD_LOGIC_VECTOR (37 downto 0);
...
signal qOut_0_stm : STD_LOGIC_VECTOR (16 downto 0);
...
signal xIn_0_dut : STD_LOGIC_VECTOR (37 downto 0);
...
signal qOut_0_dut : STD_LOGIC_VECTOR (16 downto 0);
...
dut : decimation_filter_FilterSystem_Scale3 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : decimation_filter_FilterSystem_Scale3_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
