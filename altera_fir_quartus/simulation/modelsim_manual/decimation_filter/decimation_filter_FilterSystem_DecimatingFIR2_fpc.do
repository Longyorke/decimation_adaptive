...
if {[checkDepends "$base_dir/work/dspba_library_ver/_primary.dat" "$dspba_hdl_dir/sv/base/dspba_library_ver.sv"]} {
    vlog -quiet -93  "$dspba_hdl_dir/sv/base/dspba_library_ver.sv"
}
