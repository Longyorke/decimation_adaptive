...
// SystemVerilog created from decimation_filter_FilterSystem_Scale3
...
module decimation_filter_FilterSystem_Scale3 (
    ...
    wire [37:0] u0_shiftsel_q;
    wire [37:0] u0_shiftsel_qint;
    wire [14:0] u0_rnd_replace_round_select_in;
    wire [14:0] u0_rnd_replace_round_select_b;
    wire [22:0] u0_rnd_replace_keep_select_b;
    ...
    wire [24:0] u0_rnd_replace_add_a;
    wire [24:0] u0_rnd_replace_add_b;
    logic [24:0] u0_rnd_replace_add_o;
    wire [23:0] u0_rnd_replace_add_q;
    wire [25:0] u0_low_a;
    wire [25:0] u0_low_b;
    logic [25:0] u0_low_o;
    wire [0:0] u0_low_c;
    wire [25:0] u0_high_a;
    wire [25:0] u0_high_b;
    logic [25:0] u0_high_o;
    wire [0:0] u0_high_c;


    // u0_shiftsel(BITSHIFT,4)@0
    assign u0_shiftsel_qint = xIn_0;
    assign u0_shiftsel_q = u0_shiftsel_qint[37:0];
    ...
    assign u0_rnd_replace_keep_select_b = u0_shiftsel_q[37:15];

    // u0_rnd_replace_add(ADD,19)@0
    assign u0_rnd_replace_add_a = {{2{u0_rnd_replace_keep_select_b[22]}}, u0_rnd_replace_keep_select_b};
    assign u0_rnd_replace_add_b = {24'b000000000000000000000000, u0_rnd_replace_mux_q};
    assign u0_rnd_replace_add_o = $signed(u0_rnd_replace_add_a) + $signed(u0_rnd_replace_add_b);
    assign u0_rnd_replace_add_q = u0_rnd_replace_add_o[23:0];
    ...
    // u0_high(COMPARE,9)@0
    assign u0_high_a = {{9{u0_highconst_q[16]}}, u0_highconst_q};
    assign u0_high_b = {{2{u0_rnd_replace_add_q[23]}}, u0_rnd_replace_add_q};
    assign u0_high_o = $signed(u0_high_a) - $signed(u0_high_b);
    assign u0_high_c[0] = u0_high_o[25];

    // u0_lowconst(CONSTANT,6)
    assign u0_lowconst_q = 17'b10000000000000001;

    // u0_low(COMPARE,8)@0
    assign u0_low_a = {{2{u0_rnd_replace_add_q[23]}}, u0_rnd_replace_add_q};
    assign u0_low_b = {{9{u0_lowconst_q[16]}}, u0_lowconst_q};
    assign u0_low_o = $signed(u0_low_a) - $signed(u0_low_b);
    assign u0_low_c[0] = u0_low_o[25];
