...
if {! [file exists $base_dir/decimation_filter_FilterSystem_DecimatingFIR1]} {
    file delete -force $base_dir/decimation_filter_FilterSystem_DecimatingFIR1
}

project new $base_dir decimation_filter_FilterSystem_DecimatingFIR1
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR1_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR1_atb.vhd
vcom -quiet $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR1_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps decimation_filter_FilterSystem_DecimatingFIR1_atb  -L altera_ver -L altera_mf_ver -L lpm_ver -L altera_lnsim
    do $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR1_atb.wav.do
