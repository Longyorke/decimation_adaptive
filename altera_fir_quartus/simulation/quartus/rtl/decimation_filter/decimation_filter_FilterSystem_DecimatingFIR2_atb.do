...
if [info exists ::env(QUARTUS_ROOTDIR_OVERRIDE)] {
    ...
    quietly set quartus_dir "E:/software/intelFPGA/18.1/quartus"
}

if {$argc > 0} {
    quietly set base_dir $1
} else {
    quietly set base_dir "G:/EM_LAB/EM_Instrument/TEMR-3S/Num01_code/Filter/altera_fir/./rtl"
...
if {! [file exists $base_dir/decimation_filter_FilterSystem_DecimatingFIR2]} {
    file delete -force $base_dir/decimation_filter_FilterSystem_DecimatingFIR2
}

project new $base_dir decimation_filter_FilterSystem_DecimatingFIR2
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR2_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR2_atb.vhd
vcom -quiet $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR2_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps decimation_filter_FilterSystem_DecimatingFIR2_atb  -L altera_ver -L altera_mf_ver -L lpm_ver -L altera_lnsim
    do $base_dir/decimation_filter/decimation_filter_FilterSystem_DecimatingFIR2_atb.wav.do
