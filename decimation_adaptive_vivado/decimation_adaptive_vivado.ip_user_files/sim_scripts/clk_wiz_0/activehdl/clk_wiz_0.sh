...
#
# Generated by Vivado on Fri May 02 19:09:29 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/EM_LAB/EM_Instrument/TEMR-3S/Num01_code/Filter/decimation_adaptive/decimation_adaptive_vivado/decimation_adaptive_vivado.cache/compile_simlib/activehdl"
  fi
