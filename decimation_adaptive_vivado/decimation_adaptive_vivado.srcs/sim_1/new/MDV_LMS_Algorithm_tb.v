...
module MDV_LMS_Algorithm_tb;
  ...
  reg [19:0] filterOut_out1_addr;  // ufix20
  ...
  reg  reset_1_offset;
  wire reset_1_1;
  reg [19:0] Input_Data_out1_addr;  // ufix20
  wire [19:0] Input_Data_out5_addr_delay_1;  // ufix20
  reg  tb_enb_delay;
  wire tb_enb;
  ...
  reg  adapt_offset;
  wire adapt;
  wire [19:0] Input_Data_out4_addr_delay_1;  // ufix20
  ...
  wire [19:0] Input_Data_out3_addr_delay_1;  // ufix20
  ...
  reg  valid_offset;
  wire valid;
  wire [19:0] Input_Data_out2_addr_delay_1;  // ufix20
  ...
  wire [19:0] Input_Data_out1_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterOut_out1_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterOut_signal2_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterWeights_oldCoeff_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterWeights_signal2_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterError_signal1_addr_delay_1;  // ufix20
  ...
  wire [19:0] filterError_signal2_addr_delay_1;  // ufix20
  ...
  wire [19:0] ready_addr_delay_1;  // ufix20
  ...
  assign ready_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterError_signal2_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterError_signal1_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterWeights_signal2_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterWeights_oldCoeff_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterOut_signal2_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
  ...
  assign filterOut_out1_active = filterOut_out1_addr != 20'b11010101101000000010;
  ...
  assign Input_Data_out1_active = Input_Data_out1_addr != 20'b11010101101000000010;
  ...
  //  initial value   = 0
  //  step value      = 1
  //  count to value  = 875010
  always @(posedge clk or posedge reset)
    begin : InputData_process
      if (reset == 1'b1) begin
        Input_Data_out1_addr <= 20'b00000000000000000000;
      end
      else begin
        if (Input_Data_out1_enb) begin
          if (Input_Data_out1_addr >= 20'b11010101101000000010) begin
            Input_Data_out1_addr <= 20'b00000000000000000000;
          end
          else begin
            Input_Data_out1_addr <= Input_Data_out1_addr + 20'b00000000000000000001;
          end
        end
      end
    end
...
initial begin
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        filterOut_out1_addr <= 20'b00000000000000000000;
      end
      else begin
        if (filterOut_out1_enb) begin
          if (filterOut_out1_addr >= 20'b11010101101000000010) begin
            filterOut_out1_addr <= 20'b00000000000000000000;
          end
          else begin
            filterOut_out1_addr <= filterOut_out1_addr + 20'b00000000000000000001;
          end
        end
      end
    end

  assign filterOut_out1_lastAddr = filterOut_out1_addr >= 20'b11010101101000000010;
