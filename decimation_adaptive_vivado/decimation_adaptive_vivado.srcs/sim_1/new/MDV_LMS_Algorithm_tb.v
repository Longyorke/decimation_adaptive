// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\MDV_LMS_Algorithm_tb.v
// Created: 2025-03-27 17:48:16
// 
...
module MDV_LMS_Algorithm_tb;
  ...
  wire signed [23:0] filterWeights_oldCoeff;  // sfix24_En21
  ...
  reg signed [23:0] filterWeights_oldCoeff_expected;  // sfix24_En21
  reg signed [31:0] status_filterWeights_oldCoeff_expected;  // sfix32
  wire signed [23:0] filterWeights_oldCoeff_ref;  // sfix24_En21
  ...
  assign ready_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterError_signal2_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterError_signal1_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterWeights_signal2_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterWeights_oldCoeff_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterOut_signal2_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
  ...
  assign filterOut_out1_active = filterOut_out1_addr != 16'b1000100011000010;
  ...
  assign Input_Data_out1_active = Input_Data_out1_addr != 16'b1000100011000010;
    ...
    begin : InputData_process
      if (reset == 1'b1) begin
        ...
        if (Input_Data_out1_enb) begin
          if (Input_Data_out1_addr >= 16'b1000100011000010) begin
            Input_Data_out1_addr <= 16'b0000000000000000;
          end
          else begin
...
initial begin
  ...
  MDV_LMS_Algorithm u_MDV_LMS_Algorithm (.clk(clk),
                                         ...
                                         .filterWeights_oldCoeff(filterWeights_oldCoeff),  // sfix24_En21
    ...
    begin : c_2_process
      if (reset == 1'b1) begin
        ...
        if (filterOut_out1_enb) begin
          if (filterOut_out1_addr >= 16'b1000100011000010) begin
            filterOut_out1_addr <= 16'b0000000000000000;
          end
          else begin
  ...
  assign filterOut_out1_lastAddr = filterOut_out1_addr >= 16'b1000100011000010;
...
//[]
  ...
  always @(filterWeights_oldCoeff_addr_delay_1, ce_out, tb_enb_delay)
    begin
      if (tb_enb_delay == 0) begin
        filterWeights_oldCoeff_expected <= 24'bx;
      end
      else if (ce_out == 1) begin
...
always @(posedge clk) begin
    if (ready && !ready_prev) begin  // 仅在ready上升沿时触发
