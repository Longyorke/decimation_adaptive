// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\Adder.v
...
// 
// Module: Adder
// Source Path: MDV_LMS/MDV LMS Algorithm/Filter/Accumulator/Adder
// Hierarchy Level: 3
// Model version: 8.2
// 
// -------------------------------------------------------------
...
module Adder
  ...
  input   enb_1;
  input   rst;
  input   signed [39:0] a;  // sfix40_En34
  ...
  reg  state_next;
  reg signed [41:0] u;  // sfix42_En34
  reg signed [41:0] add_cast;  // sfix42_En34
  reg signed [41:0] add_cast_0;  // sfix42_En34
  ...
  always @(a, breg, enb_1, reg_rsvd, rst, state) begin
    ...
    // signals.
    add_cast = {{2{a[39]}}, a};
    add_cast_0 = {breg[26], {breg, 14'b00000000000000}};
