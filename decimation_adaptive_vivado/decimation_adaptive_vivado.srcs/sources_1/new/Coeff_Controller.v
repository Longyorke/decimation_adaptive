// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\Coeff_Controller.v
...
// Source Path: MDV_LMS/MDV LMS Algorithm/Filter/Coefficient Memory/Coeff Controller
// Hierarchy Level: 3
// Model version: 8.2
// 
// -------------------------------------------------------------
...
module Coeff_Controller
  ...
  input   reset;
  input   enb;
  input   signed [23:0] din;  // sfix24_En21
  input   rst;
  input   coeffWrenb;
  output  signed [23:0] dout_re;  // sfix24_En21
  output  signed [23:0] dout_im;  // sfix24_En21
  ...
  Controller u_Controller (.clk(clk),
                           ...
                           .enb_1(Delay9_out1),
                           .rst(Delay1_out1),
                           .out_re(out_re),  // sfix24_En21
                           .out_im(out_im),  // sfix24_En21
                           .wrAdrs(wrAdrs),  // ufix5
                           .enbWr(enbWr)
                           );
