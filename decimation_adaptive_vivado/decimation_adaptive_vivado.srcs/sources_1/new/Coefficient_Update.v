// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\Coefficient_Update.v
...
// Source Path: MDV_LMS/MDV LMS Algorithm/Coefficient Update
// Hierarchy Level: 1
// Model version: 8.2
// 
// -------------------------------------------------------------
...
module Coefficient_Update
  ...
  input   filterEnb;
  input   signed [23:0] oldCoeff;  // sfix24_En21
  input   validCoeff;
  input   inputEnb;
  ...
  output  signed [23:0] filterWeights_oldCoeff;  // sfix24_En21
  ...
  reg signed [23:0] Delay10_reg [0:31];  // sfix24 [32]
  reg signed [23:0] Delay10_reg_next [0:31];  // sfix24_En21 [32]
  reg signed [23:0] Delay10_out1;  // sfix24_En21
    ...
    begin : Delay10_process
      if (reset == 1'b1) begin
        for(Delay10_t_1 = 32'sd0; Delay10_t_1 <= 32'sd31; Delay10_t_1 = Delay10_t_1 + 32'sd1) begin
          Delay10_reg[Delay10_t_1] <= 24'sb000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign Add2_add_cast = {{3{Delay10_out1[23]}}, {Delay10_out1, 13'b0000000000000}};
