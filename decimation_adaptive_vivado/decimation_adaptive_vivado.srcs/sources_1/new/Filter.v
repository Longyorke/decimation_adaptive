// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\Filter.v
...
// 
// Module: Filter
// Source Path: MDV_LMS/MDV LMS Algorithm/Filter
// Hierarchy Level: 1
// Model version: 8.2
// 
// -------------------------------------------------------------
...
module Filter
  ...
  input   reset;
  input   enb;
  input   signed [23:0] newCoeff;  // sfix24_En21
  ...
  wire signed [23:0] y_1;  // sfix24_En21
  wire filtEnb_1;
  wire accRst;
  wire dataRst;
  wire coeffRst;
  ...
  Coefficient_Memory u_Coefficient_Memory (.clk(clk),
                                           ...
                                           .coeffWrEnb(Tapped_Delay_out4),
                                           .rdAddrs(rdAdrs),  // ufix5
                                           .coeffIn(newCoeff),  // sfix24_En21
                                           .rst(reset_1),
                                           .coeffOut(y)  // sfix24_En21
                                           );
