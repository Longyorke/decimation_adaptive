// -------------------------------------------------------------
// 
// File Name: C:\Users\dell\Desktop\xilinx_DLP\adaptive\mdv_lms_hdl_coder\MDV_LMS\MDV_LMS_Algorithm.v
...
module MDV_LMS_Algorithm
  ...
  wire signed [23:0] Data_Type_Conversion_out1;  // sfix24_En21
  wire signed [15:0] Filter_out1;  // sfix16_En13
  wire signed [26:0] out1;  // sfix27_En20
  wire Filter_out3;
  wire signed [23:0] oldCoeff;  // sfix24_En21
  wire Filter_out5;
  ...
  wire signed [23:0] Coefficient_Update_out4_oldCoeff;  // sfix24_En21
  ...
  Data_Type_Conversion u_Data_Type_Conversion (.u1(Coefficient_Update_out1),  // sfix40_En34
                                               .y(Data_Type_Conversion_out1)  // sfix24_En21
                                               );

  Filter u_Filter (.clk(clk),
                   .reset(reset),
                   .enb(clk_enable),
                   .newCoeff(Data_Type_Conversion_out1),  // sfix24_En21
  ...
  Coefficient_Update u_Coefficient_Update (.clk(clk),
                                           ...
                                           .filterWeights_oldCoeff(Coefficient_Update_out4_oldCoeff),  // sfix24_En21
